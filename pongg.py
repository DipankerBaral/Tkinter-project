...
class Ball:
        def __init__(self, canvas,color,paddle,paddle1):
            ...
            self.canvas.move(self.id,235,300)
            start=[-3,-2,-1,0,1,2,3]
...
while 1:
    ...
    if counter==10:
        ...
        paddle.y=0
        paddle1.y=0
        canvas.create_text(250,200,text="Congrats Player1!You win!",font=32,fill="red")
    ...
    if counter1==10:
        ...
        paddle.y=0
        paddle1.y=0
        canvas.create_text(250,200,text="Congrats Player2!You win!",font=32,fill="red")
        canvas.create_text(250,215,text="Score:"+str(counter)+"-"+str(counter1),font=32,fill="red")
